...
@section('subtitle', 'Selamat datang di Perpustakaan Digital')
    ...
    <div class="col-md-4">
        <div class="stat-card" style="border-left: 4px solid #2ecc71;">
            ...
            <div>
                ...
                <h4 class="stat-value">{{ \App\Models\Peminjaman::where('user_id', Auth::id())->where('status_peminjaman', 'dipinjam')->count() }}</h4>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="stat-card" style="border-left: 4px solid #3498db;">
            ...
            <div>
                <p class="stat-label">Koleksi Saya</p>
                <h4 class="stat-value">{{ \App\Models\KoleksiPribadi::where('user_id', Auth::id())->count() }}</h4>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="section-card">
            <div class="section-header">
                ...
                <a href="{{ route('user.catalog.index') }}" class="btn-view-all">Lihat Semua <i class="bi bi-arrow-right"></i></a>
            </div>
            <div class="row g-4">
                @php
                ...
                <div class="col">
                    <a href="{{ route('user.catalog.show', $buku->id) }}" class="card book-card text-decoration-none">
