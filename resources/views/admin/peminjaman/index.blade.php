...
<div class="card shadow-sm border-0">
   ...
   <style>
    @media print {
        /* 1. Sembunyikan elemen utama layout (Sidebar, Navbar, Footer) */
        /* Sesuaikan selector ini dengan nama class/id di layouts.dashboard kamu */
        nav, .sidebar, .navbar, footer, .d-print-none, button, .alert {
            display: none !important;
        }

        /* 2. Pastikan kontainer utama tidak memiliki margin/padding dashboard */
        body, .content-wrapper, .container-fluid, .main-content {
            margin: 0 !important;
            padding: 0 !important;
            display: block !important;
        }

        /* 3. Paksa tabel agar tampil di posisi paling atas */
        .card {
        ...
        /* 4. Perjelas garis tabel untuk printer */
        .table {
            width: 100% !important;
        ...
        /* 5. Hilangkan kolom Aksi (Detail, Setujui, dll) saat cetak */
        th.d-print-none, td.d-print-none {
            display: none !important;
        }
    }
</style>
